<div class="form-row">
    <div class="col-md-3 mb-3">
        ...
        <input type="text" name="name" class="form-control"
               value="{{ old('name', isset($editor) ? $editor->name : '') }}"
               autocomplete="off" required>
    </div>
    <div class="col-md-3 mb-3">
        <label for="email" class="col-form-label pt-0">{{ __('Email') }}</label>
        <input type="email" name="email" class="form-control"
               value="{{ old('email', isset($editor) ? $editor->email : '') }}"
               autocomplete="off" required>
    </div>
    ...
    <div class="col-md-3 mb-3">
        ...
        <input type="tel" name="phone" class="form-control"
               value="{{ old('phone', isset($editor) ? $editor->phone : '') }}"
               autocomplete="off" required>
    </div>
    <div class="col-md-3 mb-3">
        <label for="gender" class="col-form-label pt-0">{{ __('Gender') }}</label>
        <select class="form-control" name="gender" id="gender">
            <option value="{{ isset($editor) ? $editor->gender : '' }}">
                {{ isset($editor) ? $editor->gender : '' }}
            </option>
