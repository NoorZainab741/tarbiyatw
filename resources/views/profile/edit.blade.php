...
@section('breadcrumb-item')
    <li class="breadcrumb-item">{{auth()->user()->role}}</li>
        ...
        <div class="edit-profile">
            <div class="row">
                        ...
                        <div class="card-body">
                            <div class="row mb-2">
                                <div class="col-auto mx-auto d-block">
                                    <img class="img-80 rounded-circle" alt="" src="{{auth()->user()->getImagePath()}}">
                                </div>
                ...
                <div class="col-lg-8 card">
                    <form class="" action="{{route('profile.update',['id' => $user->id])}}" method="post"
